...
try:
    ...
    if cursor.description is None:
        ...
        df.to_csv("ventas_12_meses_aceites.csv", index=False, encoding="utf-8-sig")
        print("✅ Archivo CSV generado exitosamente: ventas_12_meses_aceites.csv")
